...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTime != it.startTimeMilli) {
                ...
                // Hours
                append("\t ${it.endTime.minus(it.startTimeMilli) / 1000 / 60 / 60}:")
                // Minutes
                append("${it.endTime.minus(it.startTimeMilli) / 1000 / 60}:")
                // Seconds
                append("${it.endTime.minus(it.startTimeMilli) / 1000}<br><br>")
            }
        }
    }
